...
namespace Accessconnection
{
    class Program
    {
        static string CONSTR = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=test_db.mdb";
        ...
        static void Create()
        {
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(CONSTR))
                {
                    ...
                    {
                        var param = new OleDbParameter(@matricule, OleDbType.VarChar);
                        param.Value = matricule;
                        cmd.Parameters.Add(param);
                        param = new OleDbParameter(@FirtsName, OleDbType.VarChar);
                        param.Value = FirtsName;
                        cmd.Parameters.Add(param);
                        param = new OleDbParameter(@LastName, OleDbType.VarChar);
            ...
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(CONSTR))
                {
                    ...
                    using (OleDbCommand cmd = new OleDbCommand(query, con))
                    {
                        ...
                        var param = new OleDbParameter(@newMatricule, OleDbType.VarChar);
                        ...
                        param = new OleDbParameter(@oldMatricule, OleDbType.VarChar);
